import { AfterViewInit, Component, ElementRef, EventEmitter, Input, Output, ViewChild, ViewChildren, QueryList } from '@angular/core';
...
export class EditorComponent implements AfterViewInit {
	...
	public onClick( event: Event, threadId: number ) {
