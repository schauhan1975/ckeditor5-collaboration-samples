...
module.exports = {
	...
	entry: path.resolve( __dirname, 'src', 'inline-editor-with-real-time-collaboration.js' ),

	output: {
		// The name under which the editor will be exported.
		library: 'InlineEditorWithRealTimeCollaboration',

		path: path.resolve( __dirname, 'build' ),
		filename: 'inline-editor-with-real-time-collaboration.js',
		libraryTarget: 'umd',
