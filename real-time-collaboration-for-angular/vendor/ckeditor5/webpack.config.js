...
module.exports = {
	...
	entry: path.resolve( __dirname, 'src', 'classic-editor-with-real-time-collaboration.js' ),

	output: {
		// The name under which the editor will be exported.
		library: 'ClassicEditorWithRealTimeCollaboration',

		path: path.resolve( __dirname, 'build' ),
		filename: 'classic-editor-with-real-time-collaboration.js',
		libraryTarget: 'umd',
