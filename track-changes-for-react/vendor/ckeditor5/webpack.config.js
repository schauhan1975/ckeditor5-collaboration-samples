...
module.exports = {
	...
	output: {
		...
		library: 'ClassicEditorWithTrackChanges',
	...
	plugins: [
		...
		new webpack.BannerPlugin( {
			banner: [
				'CKEditor 5 with the track changes feature is licensed only under a commercial license and is protected by copyright law.',
