...
module.exports = {
	...
	entry: path.resolve( __dirname, 'src', 'balloon-block-editor-with-real-time-collaboration.js' ),

	output: {
		// The name under which the editor will be exported.
		library: 'BalloonBlockEditorWithRealTimeCollaboration',

		path: path.resolve( __dirname, 'build' ),
		filename: 'balloon-block-editor-with-real-time-collaboration.js',
		libraryTarget: 'umd',
